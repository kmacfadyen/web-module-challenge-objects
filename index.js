...
function createMenuItem(givenName, givenPrice, givenCategory){
  let newObject = {};
  newObject['name'] = givenName;
  newObject['price'] = givenPrice;
  newObject['category'] = givenCategory;
  return newObject;
}
...
function getReviewByIndex(array, number, feedback) {
